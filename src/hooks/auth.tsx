...
function AuthProvider({ children }: AuthProviderProps) {
  ...
  async function signWinthGoogle() {
    try {
      const CLIENT_ID = '85065809580-0ai6mf13mfdt7ljegh3qbbhg7mjolc8j.apps.googleusercontent.com'
      const REDIRECT_URI = 'https://auth.expo.io/@andersonp/gofinances';
  ...
  return (
    <AuthContext.Provider value={{ user, signWinthGoogle }}>
      {children}
